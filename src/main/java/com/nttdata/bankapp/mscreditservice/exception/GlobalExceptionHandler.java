...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCreditNotFoundException(CreditNotFoundException ex) {
        log.error("Credit not found exception: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCreditTypeException(InvalidCreditTypeException ex) {
        log.error("Invalid credit type exception: {}", ex.getMessage());
